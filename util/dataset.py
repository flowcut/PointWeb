...
class PointData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.num_point is None:
            ...
            # print('num point:', self.num_point)
...
if __name__ == '__main__':
    data_root = '/home/umink/AML/PointWeb/classification'
    data_list = '/home/umink/AML/PointWeb/classification/data/modelnet40_ply_hdf5_2048/train_files.txt'
