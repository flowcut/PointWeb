...
from classification.data import ModelNet40
...
def main():
    ...
    train_loader = DataLoader(ModelNet40(partition='train', num_points=args.num_point), num_workers=8,
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        loss_train, acc_train, avg_acc_train = train(train_loader, model, criterion, optimizer, epoch)
        epoch_log = epoch + 1
        writer.add_scalar('loss_train', loss_train, epoch_log)
        writer.add_scalar('acc_train', loss_train, epoch_log)
        writer.add_scalar('avg_acc_train', loss_train, epoch_log)
